...
plot_pt.lat1 = plot_pts.lat'*1.011;
plot_pt.lat2 = plot_pts.lat';
plot_pt.lat = (plot_pt.lat1 + plot_pt.lat2)/2;

plot_pt.lon1 = plot_pts.lon'*(.990);
plot_pt.lon2 = plot_pts.lon'
plot_pt.lon = (plot_pt.lon1+plot_pt.lon2)/2;

plot_pt.z1 = plot_pts.z'*0.35;
plot_pt.z2 = plot_pts.z'
plot_pt.z = (plot_pt.z+plot_pt.z)/2;

plot_pt.val1 = plot_pts.val'*0.25;
plot_pt.val2 = plot_pts.val'
plot_pt.val =plot_pt.val1-plot_pt.val2;
...
%     plot(ss,ww,'k--','linestyle','-')
   ...
   cs = max(abs([-0.8, 0.8]));
    ...
    print('figures/final_VXsections/v01A_syn2.pdf','-dpdf','-r950');
