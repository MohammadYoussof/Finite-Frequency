...
% %             y2=ya+200; y1=y2-300;  
    ...
    make_DS_map_synth_invention(mf,m,par,stax,stay); 
    upsample_model_syn_mf_invention(mf,par,1);
    toc
    upsample_model_syn_m_invention(m,par,1);
    toc
    save block_mod_invention1